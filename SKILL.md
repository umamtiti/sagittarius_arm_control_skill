...
- Main command wrapper: `~/.openclaw/workspace/skills/sagittarius-arm-control/scripts/arm_cmd.sh`
- Backend launcher: `~/.openclaw/workspace/skills/sagittarius-arm-control/scripts/arm_backend.sh`
...
- If a command fails because readiness is false, report which subsystem is failing and suggest `~/.openclaw/workspace/skills/sagittarius-arm-control/scripts/arm_backend.sh` or the manual `~/team2` backend launch commands above.
